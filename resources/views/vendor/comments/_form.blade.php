    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group mt-4">
                <textarea class="border-2 w-full form-control p-2 @if($errors->has('message')) is-invalid @endif" name="message" rows="5" placeholder="Viết bình luận ...."></textarea>
            </div>
            <button type="submit" class="bg-red-600 p-2 rounded-lg text-white float-right my-4">@lang('comments::comments.submit')</button>
        </form>
    </div>
</div>
<br />
