    ...
    <div class="md:mx-16 mt-10">
                ...
                <div class="md:grid md:grid-cols-3 md:gap-10">
                    <div class="col-span-2">
                            <div class="relative pb-2 md:pb-10">
                                ...
                                <div class="font-[PTSerif] font-bold text-lg ml-4 md:ml-0 md:text-4xl bg-white absolute -mt-14 md:-mt-20 w-5/6 px-6 pt-2">
                    ...
                    <div class="col-span-1 mx-4 md:mx-0">
                        <div class="flex flex-col">
                            <div class="grid grid-cols-5">
                                <p class="col-span-4 md:col-span-5 bg-[#FBFF22] font-[Roboto] py-1 md:p-2 w-2/5 md:w-2/5 text-sm font-bold md:text-lg text-gray-600 mt-4 md:mt-0 text-center">TOP STORIES</p>
                                <div class="md:hidden text-blue-600 float-right mt-4 text-sm">View all</div>
                            </div>
                            <div class="my-2 font-[PTSerif] border-dashed md:border-solid border-b-2 md:pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="mb-2 font-[PTSerif]  border-dashed md:border-solid border-b-2 md:pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="mb-2 font-[PTSerif]  border-dashed md:border-solid border-b-2 md:pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="mb-2 font-[PTSerif]  border-dashed md:border-solid border-b-2 md:pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="hidden md:block mb-2 font-[PTSerif] border-dashed md:border-solid border-b-2 pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="hidden md:block mb-2 font-[PTSerif] border-dashed md:border-solid border-b-2 pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="hidden md:block mb-2 font-[PTSerif] pb-2 ml-2 md:ml-0 md:text-xl">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                        </div>
                    </div>
                </div>
             </div>
        ...
        <div class="md:grid md:grid-cols-6 md:gap-4 mb-4 md:mb-10 mx-4 md:mx-0">
            <div class="col-span-1 md:border-r-2 md:pr-4 md:border-gray-200">
                <div class="flex flex-col md:border-b-2 md:border-b-0">
                    <div class="border-b-2 md:border-b-0">
                        <p class="bg-gray-100 font-medium md:p-2 md:text-lg w-1/3 md:w-3/5 text-gray-600 text-center">WORLD NEWS</p>
                    </div>
            ...
            <div class="col-span-4 md:px-2 md:border-r-2 md:pr-4 md:border-gray-200 font-['Roboto']">
                <div class="md:grid md:grid-cols-3 md:gap-4">
                    <div class="col-span-2 md:border-r-2 md:pr-4 md:border-gray-200">
                        <div class="border-dashed md:border-solid border-b-2 pb-4">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="col-span-2 pr-6 md:text-lg">
                    ...
                    <div>
                        <div class="flex flex-col">
                            <div>
                                <p class="mt-4 md:mt-0 bg-[#FBFF22] pt-0.5 text-sm font-bold md:p-2 w-2/5 md:w-1/2 md:text-lg text-gray-700 text-center">ENTERTAINMENT</p>
                            </div>
                            <div class="my-2 border-dashed md:border-solid border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="my-2 border-dashed md:border-solid border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="my-2 border-dashed md:border-solid border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="my-2 border-dashed md:border-solid border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="my-2 mb-8 md:mb-0 border-dashed md:border-solid border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="hidden md:block my-2 border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="hidden md:block my-2 border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                            <div class="hidden md:block my-2 border-b-2 pb-2 md:text-lg">PM unveils Shia status in Coimbatore on Mahashivratri</div>
                        </div>
                    </div>
            ...
            <div class="col-span-1 font-['Roboto']">
                <div class="flex flex-col md:border-b-2 md:border-gray-200">
                    <div class="border-b-2 md:border-b-0">
                        <p class="bg-gray-100 font-medium md:p-2 md:text-lg w-1/3 md:w-3/5 text-gray-800 text-center">SPORTS NEWS</p>
                    </div>
        ...
        <div class="md:grid md:grid-cols-6 md:gap-4 border-b-2 mb-4 md:mb-10 md:mx-0">
            <div class="col-span-5">
                <div class="font-['Roboto']">
                    <div class="hidden md:block md:grid md:grid-cols-6 bg-gray-300 py-2 ">
                        <div class="col-span-1 text-xl md:text-2xl pl-4 font-bold text-gray-700">Videos</div>
                        <div class="col-span-4"></div>
                        <div class="col-span-1 text-right md:text-xl text-blue-600 pr-2 font-bold"> View all Videos</div>
                    </div>
                                ...
                                <div class="flex flex-wrap" id="tabs-id">
                                    <div class="w-full">
                                        <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row">
                                            ...
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-News')">
                                                    <i class="fas fa-cog text-base mr-1"></i>  News
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Entertainment')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Entertainment
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Celebs')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Celebs
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Movie')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Movie
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Lifestyle')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Lifestyle
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Sports')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Sports
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Tech')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Tech
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Business')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Business
                                                </a>
                                            </li>
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black" onclick="changeAtiveTab(event,'tab-Auto')">
                                                    <i class="fas fa-briefcase text-base mr-1"></i>  Auto
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full">
                                            <div class="px-4 py-5 flex-auto">
                                                <div class="tab-content tab-space">
                                                    ...
                                                    <div class="hidden" id="tab-News">
                                                        <div class="relative">
                                                            <img src="/img/img_9.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                                    <div class="col-span-1">
                                                                        <div class="border-2 border-solid rounded-full w-16 h-16 mt-4 border-gray-400">
                                                    ...
                                                    <div class="hidden" id="tab-Entertainment">
                                                        <div class="relative">
                                                            <img src="/img/img_10.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                                    <div class="col-span-1">
                                                                        <div class="border-2 border-solid rounded-full w-16 h-16 mt-4 border-gray-400">
                                                    ...
                                                    <div class="hidden" id="tab-Celebs">
                                                        <div class="relative">
                                                            <img src="/img/img_11.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                                    <div class="col-span-1">
                                                                        <div class="border-2 border-solid rounded-full w-16 h-16 mt-4 border-gray-400">
                                                    ...
                                                    <div class="hidden" id="tab-Lifestyle">
                                                        <div class="relative">
                                                            <img src="/img/img_9.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                    ...
                                                    <div class="hidden" id="tab-Sports">
                                                        <div class="relative">
                                                            <img src="/img/img_10.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                    ...
                                                    <div class="hidden" id="tab-Business">
                                                        <div class="relative">
                                                            <img src="/img/img_8.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                    ...
                                                    <div class="hidden" id="tab-Auto">
                                                        <div class="relative">
                                                            <img src="/img/img_1.png" class="w-full">
                                                            <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                                <div class="grid grid-cols-6 gap-4">
                                                                    <div class="col-span-1">
                                                                        <div class="border-2 border-solid rounded-full w-16 h-16 mt-4 border-gray-400">
                ...
                <div class="md:hidden mx-4 font-['Roboto']">
                    <div class="border-dashed md:border-solid border-b-2 pb-4">
            ...
            <div class="col-span-1 hidden md:block font-['Roboto']">
                <div class="flex flex-col">
                    <div class="mb-6">
                        <p class="bg-[#FBFF22] font-bold p-2 w-3/5 text-lg text-gray-700 text-center">MOST POPULAR</p>
                    </div>
                    <div class="my-2text-lg text-gray-900 relative">
