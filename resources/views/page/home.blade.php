...
<div class="md:mx-16 mt-10">
    <div class="md:grid md:grid-cols-4 md:gap-4 mt-10">
            ...
            <div class="md:grid md:grid-cols-3 md:gap-10">
                <div class="col-span-2">
                    ...
                    <div class="font-roboto hidden md:block md:pl-4 text-xl">
                        Clues from a propaganda photo reveal details about North Korea’s expanding weapons programs and
                        internal politics.
                    </div>
                </div>
                <div class="col-span-1 mx-4 md:mx-0">
                    <div class="flex flex-col font-roboto">
                        <div class="grid grid-cols-5">
                            <p class="col-span-4 md:col-span-5 bg-[#FBFF22] py-1 md:p-2 w-2/5 md:w-2/5 text-sm font-bold md:text-lg text-gray-600 mt-4 md:mt-0 text-center">
                                TOP STORIES</p>
        ...
        <div class="col-span-1 md:px-6 mx-4 md:mx-0">
            <div class="flex flex-col bg-blue-50">
                <div>
                    <p class="bg-[#FBFF22] font-roboto py-1 md:p-2 w-2/6 md:w-2/5 text-sm font-bold md:text-lg text-gray-600 md:mt-0 text-center">
                        QUICK BITES</p>
                </div>
    ...
    <div class="md:grid md:grid-cols-4 md:gap-4 mb-4 mx-4 md:mx-0">
        <div class="col-span-3 md:border-b-2 md:border-solid pb-10">
            <div class="flex md:grid md:grid-cols-12 md:py-4 border-b-2 my-4 md:border-b-0 md:my-0 font-roboto">
                <div
                    class="bg-gray-100 md:bg-gray-300 col-span-1 px-1 py-0.5 md:p-2 font-medium text-gray-700 text-center">
                    FEATURE
                </div>
                ...
                <div class="hidden md:block col-span-1 pt-2 text-blue-400 font-bold text-right md:text-lg">View all
                </div>
            </div>
    ...
    <div class="md:grid md:grid-cols-6 md:gap-4 mb-4 md:mb-10 mx-4 md:mx-0">
        <div class="col-span-1 md:border-r-2 md:pr-4 md:border-gray-200">
            <div class="flex flex-col">
                <div class="border-b-2 md:border-b-0">
                    <p class="bg-gray-100 font-medium md:p-2 md:text-lg w-1/3 md:w-3/5 text-gray-700 text-center font-roboto">
                        WORLD NEWS</p>
                </div>
        ...
        <div class="col-span-4 md:px-2 md:border-r-2 md:pr-4 md:border-gray-200 font-['Roboto']">
            <div class="md:grid md:grid-cols-3 md:gap-4">
                <div class="col-span-2 md:border-r-2 md:pr-4 md:border-gray-200">
                    <div class="border-dashed border-b-2 pb-4">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="col-span-2 pr-6 md:text-lg font-roboto">
                                India’s government expressed shock after one citizen was killed and another wounded in a
                    ...
                    <div class="hidden border-dashed border-b-2 pb-4 pt-4  md:block ">
                        ...
                        <div class="md:text-lg font-roboto">
                            The suit, brought by the autonomous car business Waymo, accuses Uber and a star engineer,
                            Anthony Levandowski, of planning to steal trade secrets.
                        </div>
                    </div>
                ...
                <div>
                    <div class="flex flex-col">
                        <div>
                            <p class="mt-4 md:mt-0 bg-[#FBFF22] pt-0.5 text-sm font-roboto font-bold md:p-2 w-2/5 md:w-1/2 md:text-lg text-gray-700 text-center">
                                ENTERTAINMENT</p>
                        </div>
                        <div class="hidden md:block">
        ...
        <div class="col-span-1 font-['Roboto']">
            <div class="flex flex-col md:border-b-2 md:border-gray-200">
                <div class="border-b-2 md:border-b-0">
                    <p class="bg-gray-100 font-medium md:p-2 md:text-lg w-1/3 md:w-3/5 text-gray-800 text-center mt-4 md:mt-0 font-roboto">
                        SPORTS NEWS</p>
                </div>
    ...
    <div class="md:grid md:grid-cols-6 md:gap-4 border-b-2 mb-4 md:mb-10 md:mx-0">
        <div class="col-span-5">
            <div class="font-['Roboto']">
                <div class="hidden md:block md:grid md:grid-cols-6 bg-gray-300 py-2 ">
                    <div class="col-span-1 text-xl md:text-2xl pl-4 font-bold text-gray-700 font-['Merriweather']">
                        Videos
                    </div>
                    <div class="col-span-4"></div>
                    <div class="col-span-1 text-right md:text-xl text-blue-600 pr-2 font-bold font-roboto"> View all
                        Videos
                    </div>
                </div>
                <div
                                ...
                                <div class="w-full">
                                    <ul class="flex mb-0 list-none flex-wrap pt-3 pb-4 flex-row font-roboto">
                                        <li class="-mb-px last:mr-0 flex-auto text-center">
                                            <a class="block leading-normal text-blue-700"
                                               onclick="changeAtiveTab(event,'tab-Trending')">
                                        ...
                                        @foreach($listVides as $ls)
                                            <li class="-mb-px last:mr-0 flex-auto text-center">
                                                <a class="block leading-normal text-black"
                                                   onclick="changeAtiveTab(event,'tab-{{ $ls }}')">
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <div class="absolute -mt-28 text-white ml-2 md:w-5/6 md:ml-10">
                                                            <div class="grid grid-cols-6 gap-4">
                                                                ...
                                                                <div class="col-span-5">
                                                                    <p class="text-xl font-bold md:text-3xl">Isro
                                                                        launches 104 satellites in a single mission to
                                                                        create world record</p>
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="grid grid-cols-6 gap-4">
                                                                    ...
                                                                    <div class="col-span-5">
                                                                        <p class="text-xl font-bold md:text-3xl">Isro
                                                                            launches 104 satellites in a single mission
                                                                            to create world record</p>
                                                                        <p>2:30 | By Telegraph</p>
                                                                    </div>
                                                                </div>
                                                            </div>
            ...
            <div class="relative md:hidden">
                ...
                <div class="absolute -mt-28 text-white ml-2 md:ml-10">
                    <div class="grid grid-cols-6 gap-4">
                        ...
                        <div class="col-span-5">
                            <p class="text-lg font-bold">Isro launches 104 satellites in a single mission to create
                                world record</p>
            ...
            <div class="md:hidden mx-4">
                <div class="border-dashed md:border-solid border-b-2 pb-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="col-span-2 pr-6 font-roboto">
                            Two European museums are presenting retrospectives of a man many consider to be one of the
                ...
                <div class="pb-4">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        <div class="col-span-2 pr-6 font-roboto">
                            Auctions of Impressionist, modern and Surrealist art at Sotheby’s and Christie’s will be the
        ...
        <div class="col-span-1 hidden md:block font-['Roboto']">
            <div class="flex flex-col">
                <div class="mb-6">
                    <p class="bg-[#FBFF22] font-bold p-2 w-3/5 text-lg text-gray-700 text-center font-roboto">MOST
                        POPULAR</p>
                </div>
