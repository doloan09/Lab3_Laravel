                ...
                <div id="dropdown-wrapper-category" class="hidden md:block inline-block text-sm md:text-lg mt-2">
                    ...
                    <div id="menu" class="hidden flex flex-col bg-white drop-shadow-md absolute -ml-20">
                        @if($user)
                            ...
                            <a class="px-5 py-3 hover:bg-gray-300 border-b border-gray-200 flex" href="/logout">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        @else
                            <a class="px-5 py-3 hover:bg-gray-300 border-b border-gray-200 flex" href="{{ route('register') }}">
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <a class="px-5 py-3 hover:bg-gray-300 border-b border-gray-200 flex" href="/login">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
