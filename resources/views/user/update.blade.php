...
@section('content')
    <div class="grid grid-cols-3 mt-10 h-screen">
        ...
        <div class="md:col-span-1 col-span-3">
            ...
            <form action="{{ route('auth-admin.update-user', ['id' => $item->id]) }}" method="POST">
                @csrf
                <div class="mt-10">
                    <p class="pr-3">UserName:</p>
                    <input type="text" name="name" class="border border-gray-300 p-2 w-full" placeholder="User name" value="{{$item->name}}"><br>
                </div>
                @if($errors->has('name'))
                ...
                <div class="my-6">
                    ...
                    <p class="border border-gray-300 p-2 w-full">{{$item->email}}</p><br>
                </div>
